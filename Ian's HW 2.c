...
double random_value;
        ...
        while(i<50)

            {
                ...
                switch(random_value)
                  {
                    case (random_value>=4.0 && random_value<=4.5): printf ( "%8.1f\n", random_value);
                                                                   i++;
                    break;

                    case (random_value>=4.6 && random_value<=5.0): printf ( "%20.1f\n", random_value);
                                                                   i++;
                    break;

                    case (random_value>=5.1 && random_value<=5.5): printf ( "%32.1f\n", random_value);
                                                                   i++;
                    break;

                    case (random_value>=5.6 && random_value<=6.0): printf ( "%44.1f\n", random_value);
                                                                   i++;
                    break;
